...
\begin{document}
	\begin{tikzpicture}[scale=3, line join=round, line cap=round,
		...
		\begin{scope}[canvas is xz plane at y=0, transform shape]
			\node[blue!60!black, xscale=1, centered, yscale=1.2, scale=0.4] at (\mu,0.5) {pvalue};
		...
		\end{scope}
			...
			\draw [-{Latex[length=1mm]}] (\mu - 0.5, \mu + 0.5, 0) -- ({\mu + 0.5}, {\mu - 0.5}, 0) node [above right] {$\Delta y$};
			\draw [-{Latex[length=1mm]}] (\mu + 0.5, \mu + 0.5, 0) -- ({\mu - 0.5}, {\mu - 0.5}, 0) node [right] {$\nabla y$};
